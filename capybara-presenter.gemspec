...
Gem::Specification.new do |spec|
  ...
  spec.description = 'Transform Capybara system tests into polished presentations with automatic delays, ' \
                     'browser notifications, and visual cues perfect for creating professional test recordings ' \
                     'and demonstrations.'
